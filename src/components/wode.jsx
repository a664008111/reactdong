...
export default class Wode extends React.Component{
    ...
    componentWillMount(){
        fetch("https://c.y.qq.com/v8/fcg-bin/fcg_v8_toplist_cp.fcg?g_tk=5381&uin=0&format=json&inCharset=utf-8&outCharset=utf-8¬ice=0&platform=h5&needNewCode=1&tpl=3&page=detail&type=top&topid=27&_=1519963122923").then(res=>{
            res.json().then(body=>{
                console.log(body)
            })
        })
